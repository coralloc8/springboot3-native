package com.coral.test.spring.natives.enums;

import com.coral.test.spring.natives.core.enums.IEnum;
import com.coral.test.spring.natives.core.r2dbc.IMapping;
 ...
 */
public enum EventStatus implements IEnum<EventStatus, Integer>, IMapping<Integer> {
