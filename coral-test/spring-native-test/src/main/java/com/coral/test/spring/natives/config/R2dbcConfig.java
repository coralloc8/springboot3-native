...
import com.coral.test.spring.natives.core.web.convert.EnumToInteger;
import com.coral.test.spring.natives.core.web.convert.EnumToString;
import com.coral.test.spring.natives.core.web.convert.IntegerToEnumConverterFactory;
import com.coral.test.spring.natives.core.web.convert.StringToEnumConverterFactory;
    ...
    public ConnectionFactory connectionFactory() {
        ...
        try {
            ...
            connectionFactoryOptions = ConnectionFactoryOptions.builder()
                    ...
                    .option(ConnectionFactoryOptions.HOST, "192.168.29.66")
                    .option(ConnectionFactoryOptions.PORT, 3306)
                    .option(ConnectionFactoryOptions.DATABASE, "testdb")
                    .option(ConnectionFactoryOptions.USER, "zhyx")
                    .option(ConnectionFactoryOptions.PASSWORD, "zhyx")
                    .build();
