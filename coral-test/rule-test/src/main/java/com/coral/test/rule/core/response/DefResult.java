package com.coral.test.rule.core.response;


import com.coral.test.rule.core.enums.ErrorMessageEnum;
import com.coral.test.rule.core.exception.IErrorCode;
...
public class DefResult<T> implements IResult<T> {
    ...
    public static <T> IResult<T> success() {
        return new DefResult<>(ErrorMessageEnum.SUCCESS.getCode(), ErrorMessageEnum.SUCCESS.getMessage(), null);
    }
