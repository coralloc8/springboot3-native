package com.coral.test.spring.simple.core.r2dbc;

import com.coral.test.spring.simple.core.enums.GlobalOrder;
import com.coral.test.spring.simple.core.utils.NameStyleUtil;
...
import com.coral.test.spring.simple.core.utils.reflection.LambdaFieldUtil;
...
public class SQLFactory {
    ...
    public static String buildFullSql(String sql, Criteria whereCriteria) {
        ...
        sql = formatSql(sql);
        if (Objects.isNull(whereCriteria)) {
            return sql;
        }
