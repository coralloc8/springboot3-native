package com.coral.test.spring.simple.config;

import com.coral.test.spring.simple.core.opendoc.config.OpenApiConfig;
import com.coral.test.spring.simple.core.opendoc.config.OpenApiProperties;
